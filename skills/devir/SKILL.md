...
- Notlar dizini: `<ana-worktree>/.claude/docs/devir-notes/` (paylaşılan + kalıcı — `git rev-parse --git-common-dir` ebeveyni; linked worktree'de bile ana checkout'a yazılır, prune'da kaybolmaz). Yoksa oluştur. Arşiv: `.../archive/` (taranmaz).
